			...
			<div>
				<nav className="navbar navbar-expand-lg  navbar-dark bg-dark">
					<div className="container-fluid">
						...
						<button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSufpportedContent" aria-expanded="false" aria-label="Toggle navigation">
						...
						<div className="collapse navbar-collapse" id="navbarSupportedContent">
							<ul className="navbar-nav me-auto mb-2 mb-lg-0">
								...
								<li className="nav-item"><NavLink activestyle={{ color: '' }} className="nav-link" to="/technology">Technology</NavLink></li>
							</ul>
						</div>
					</div>
				</nav>
